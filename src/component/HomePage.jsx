...
import myResume from '../assets/pdf/AMAN_PORTFOLIO.pdf';
          ...
          <section className="introSection">
            <div style={{ display: "flex" }}>
              <div className="introText">
                <h1>MY NAME IS AMAN RAUTELA</h1>
                <p>FRONTEND REACT DEVELOPER</p>
                <p>
                  Based in Dehradun, IND{" "}
                  <FontAwesomeIcon
                    icon={faLocationDot}
                    style={{ color: "red" }}
                  />
                ...
                <div className="contactBtns">
                  <a
                    target="#"
                    href="https://www.linkedin.com/in/aman-rautela-9b31b2286/"
                  >
                    <FontAwesomeIcon className="linkedin" icon={faLinkedin} />
                  </a>
                  <a target="#" href="https://github.com/Aman-Rautela">
        ...
        <ParallaxLayer offset={1}>
          <section className="aboutMe">
            <div className="aboutIntro">
              <h2>ABOUT ME</h2>
              <p>
                Hello! I am a Front End developer based in Dehradun, IND.
                Currently building a strong and growing skill set in HTML5, CSS3/SCSS,
                JavaScript, React. I consistently improve a keen eye for design
